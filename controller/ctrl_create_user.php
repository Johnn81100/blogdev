        ...
        !empty($_POST['mail_util']) AND !empty($_POST['password_util']))
        {
            ...
            if(empty($exist))
            {
                ...
                if(isset($_FILES['img_util']) AND ($_FILES['img_util']['name']))
                {
                    ...
                    $tmpName = $_FILES['img_util']['name']; 
                    $size = $_FILES['img_util']['name']; 
                    $error = $_FILES['img_util']['name']; 
                ...
                <a href='http://localhost/blogdev/activate?mail=$mail'>activation du compte</a>";
